...
def main(args):
    # 初始化wandb
    wandb.init(project="NVIB", entity="rafachang")
    ...
    if utils.is_main_process():
        wandb.log({'eval/acc1':test_stats['acc1']})
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            set_mata_training_mode=True, #TODO: it is for NVIB, it may always be True in "train_one_epoch"
